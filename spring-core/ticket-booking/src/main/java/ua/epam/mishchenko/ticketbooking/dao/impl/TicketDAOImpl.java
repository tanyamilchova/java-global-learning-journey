...
public class TicketDAOImpl implements TicketDAO {
    ...
    public List<Ticket> getAll() {
        logger.debug("Finding all tickets in the database");
        ...
        logger.debug("All tickets successfully found");
    ...
    public List<Ticket> getAllByUser(User user, int pageSize, int pageNum) {
        logger.debug("Finding all booked tickets by user '{}' in the database using pagination", user);
    ...
    public List<Ticket> getAllByEvent(Event event, int pageSize, int pageNum) {
        logger.debug("Finding all booked tickets by event '{}' in the database using pagination", event);
    ...
    public Ticket insert(Ticket ticket) {
        logger.debug("Start inserting of the ticket: {}", ticket);
        ...
        logger.debug("Successfully insertion of the ticket: {}", ticket);
    ...
    public Ticket update(Ticket ticket) {
        logger.debug("Start updating of the ticket: {}", ticket);
        ...
        logger.debug("Successfully update of the ticket: {}", ticket);
    ...
    public boolean delete(long ticketId) {
        logger.debug("Start deleting of the ticket with id: {}", ticketId);
        ...
        logger.debug("Successfully deletion of the ticket with id: {}", ticketId);
