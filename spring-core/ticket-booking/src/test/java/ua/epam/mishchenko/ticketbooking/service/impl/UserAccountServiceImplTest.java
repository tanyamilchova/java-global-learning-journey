...
public class UserAccountServiceImplTest {
    ...
    public void getUserAccountByUserIdWithExistsIdShouldBeOk() {
        ...
        UserAccount actualUserAccount = userAccountService.getAccountByUserId(userId);
    ...
    public void getUserAccountByIdWithExceptionShouldReturnNull() {
        ...
        UserAccount actualUserAccount = userAccountService.getAccountByUserId(10L);
    ...
    public void updateUserAccountWithExceptionShouldReturnNull() {
        ...
        UserAccount actualUserAccount = userAccountService.updateAccount(new UserAccountImpl());
