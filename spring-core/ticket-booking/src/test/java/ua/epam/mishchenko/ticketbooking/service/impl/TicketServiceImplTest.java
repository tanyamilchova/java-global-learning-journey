...
public class TicketServiceImplTest {
    ...
    public void setUp() {
        ...
        ticketService.setEventDAO(eventDAO);          // inject mock EventDAO
    ...
    public void bookTicketWithNotBookedTicketShouldBeOk() {
        ...
        UserAccount realUserAccount = new UserAccountImpl(userId, 100); // real object
        ...
        assertEquals(50.0, realUserAccount.getBalance(), 0.001); // now balance updates correctly
    }
//    @Test
